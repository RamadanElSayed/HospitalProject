                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="panel panel-white">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form action="doctor-specialization.php" name="dcotorspcl" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15">Manage <span
                                    class="text-bold" style="font-weight: bold">Docter Specialization</span></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                ...
                                                <a title="remove" href="doctor-specialization.php?id=<?php echo $row['id'] ?>&del=delete"
                                                   onClick="return confirm('Are you sure you want to delete?')"
                                                   class="btn btn-transparent btn-xs tooltips" tooltip-placement="top"
                                                   tooltip="Remove">Remove</a>
